...
const GOOGLE_MAPS_API_KEY = 'AIzaSyDovPFfMoi51Y2wPOfgy770OBDkTA7aOkQ'
export default {
    name: 'GPS4',
        ...
        */
        ...
        loader.load().then(() => {
            ...
            google.maps.event.addListener(marker.value, 'dragend', function () {
                ...
                resul_lat.value = marker.value.getPosition().lat()
                resul_lng.value = marker.value.getPosition().lng()
                center = {
                    lat: resul_lat.value,
                    lng: resul_lng.value
                }
